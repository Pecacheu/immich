...
<div role="listbox" {id}>
  {#if isOpen}
    <div
      ...
      bind:this={mainView}
      class="absolute z-1 w-full rounded-b-3xl bg-white shadow-[0_8px_20px_rgba(0,0,0,0.12)] transition-all dark:bg-immich-dark-gray dark:text-gray-300 overflow-hidden"
    >
